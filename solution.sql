...
-- 8. Add a new record.
INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('glyde', 'minneapolis', 7, 20, 1000000.99);
...
DELETE from syntax_practice
	WHERE transactions_completed < 5 AND 
